  ...
  const runAllChecks = useCallback(async () => {
    ...
    if (hasDirectKey) {
      ...
      try {
        ...
        update("ai", {
          stat: r?.ok ? "ok" : "warn",
          detail: r?.ok ? "Gemini via servidor â (cortesia Replit)" : "Servidor offline â adicione chave Gemini nas ConfiguraÃ§Ãµes",
        });
      } catch {
          ...
          {done && (
            <View style={{ marginTop: 20, backgroundColor: "#0d1f0d", borderWidth: 1, borderColor: "#1f4d1f", borderRadius: 12, padding: 14 }}>
              ...
              {(hasDirectKey ? [
                ...
                "Gemini IA: precisa do servidor Replit OU adicione sua chave em ConfiguraÃ§Ãµes",
